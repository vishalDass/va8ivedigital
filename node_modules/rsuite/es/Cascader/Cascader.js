...
function (_React$Component) {
  ...
  function Cascader(props) {
    ...
    _this.handleSelect = function (node, cascadeItems, activePaths, isLeafNode, event) {
      ...
      _this.setState({
        ...
        var updatePosition = _get(_this.positionRef, 'current.updatePosition');
  ...
  Cascader.getDerivedStateFromProps = function getDerivedStateFromProps(nextProps, prevState) {
    ...
    if (data !== prevState.data) {
      ...
      var selectNodeValue = _get(prevState, ['selectNode', valueKey]);

      if (selectNodeValue) {
        var newChildren = _get(findNodeOfTree(data, function (item) {
