...
function (_React$PureComponent) {
  ...
  _proto.renderDays = function renderDays() {
    ...
    var _loop = function _loop(i) {
      ...
      var classes = (0, _classnames.default)(_this2.addPrefix('cell'), (_classNames = {}, _classNames[_this2.addPrefix('cell-un-same-month')] = !(inSameMonth && inSameMonth(thisDate)), _classNames[_this2.addPrefix('cell-is-today')] = isToday, _classNames[_this2.addPrefix('cell-selected')] = (0, _is_same_day.default)(thisDate, selected), _classNames[_this2.addPrefix('cell-disabled')] = disabled, _classNames));
      ...
      days.push(React.createElement(_IntlContext.default.Consumer, {
        ...
        return React.createElement("div", {
          ...
          role: "menu",
          tabIndex: -1,
          title: isToday ? title + " (" + (0, _get2.default)(context, 'today') + ")" : title,
