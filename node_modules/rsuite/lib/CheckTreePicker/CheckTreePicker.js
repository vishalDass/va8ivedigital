...
function (_React$Component) {
  ...
  function CheckTreePicker(_props) {
    ...
    _this.handleToggle = function (node) {
      ...
      onExpand && onExpand(nextExpandItemValues, node, (0, _Picker.createConcatChildrenFunction)(node, node[valueKey]));
    };
  ...
  _proto.render = function render() {
    var _this$props12 = this.props,
        ...
        rest = (0, _objectWithoutPropertiesLoose2.default)(_this$props12, ["cascade", "style", "locale", "inline", "disabled", "valueKey", "labelKey", "cleanable", "countable", "placeholder", "toggleComponentClass", "onExited", "onEntered", "onClean", "renderValue"]);
