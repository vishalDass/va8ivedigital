...
var Explore = function Explore(props) {
  ...
  return __jsx("div", {
    ...
    __self: this
  }, renderRestaurantInfo), console.log(props.result));
};

renderRestaurantInfo = function renderRestaurantInfo() {
  console.log("TRAILS", _this.props.result); //   if(this.props.trails.trails){
...
//# sourceMappingURL=explore.js.731970434078bbe60a68.hot-update.js.map